...
$(document).on("click", function (e) {
  ...
  if ($target.closest(".breadcrumbs-stock__download-tooltip").length === 0 && $target.closest(".breadcrumbs-stock__button").length === 0) {
    console.log("lool");
...
$(window).on("load", function () {
  window.onApiKeyRequestSended = function () {
    ...
    $("#" + containerId).parent().addClass("api-page__api-key-cl");
  };
  ...
  window.showAlert = function () {
    ...
    let contentTarget = tplParams.templateSelector;
    let containerId = (contentTarget + "-outer-" + modal.tplParams.uniqId).substr(1);
    $("#" + containerId).parent().addClass("erp-alert");
  };
